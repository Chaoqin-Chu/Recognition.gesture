function rFSDs = fsd(outline,H,b,bN)
...
%H = iNoOfHarmonicsAnalyse 
%b = bNormaliseSizeState   %[m n] = size(outline), b = m; 
%bN = bNormaliseOrientationState

rTwoNPi = (1:1:H)* 2 * pi;
rTwoNSqPiSq = (1:1:H) .* (1:1:H)* 2 * pi * pi;
...
end % if (b == 1) || (bNormaliseOrientationState == 1)